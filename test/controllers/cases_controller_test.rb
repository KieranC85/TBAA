...
class CasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post cases_url, params: { case: { CaseId: @case.CaseId, Created: @case.Created, Description: @case.Description } }
    end
  ...
  test "should update case" do
    patch case_url(@case), params: { case: { CaseId: @case.CaseId, Created: @case.Created, Description: @case.Description } }
